...
package me.tjquinn.mp.quickstart;
...
public class GreetResource {
    ...
    @Inject
    private MyBean unqualified;

    @Inject
    @MyQualifier(scope = "myScope")
    private MyBean myScopeBean;

    @Inject
    @MyQualifier(scope = "yourScope")
    private MyBean yourScopeBean;

    @Inject
    @MyQualifier()
    private MyBean defaultScopeBean;
    ...
    public Message getDefaultMessage() {
        return createResponse("World (unq=" + unqualified.description()
                                      + ", myScope=" + myScopeBean.description()
                                      + ", yourScope=" + yourScopeBean.description()
                                      + ", defaultedScope=" + defaultScopeBean.description() + ")");
    }
